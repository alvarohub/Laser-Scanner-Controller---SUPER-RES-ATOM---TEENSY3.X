...
namespace DisplayScan {
    ...
    void displayISR() {
        ...
        switch(stateDisplayEngine) {
            ...
            case STATE_IDLE:
            if (sizeBufferDisplay) stateDisplayEngine = STATE_START_BLANKING;
            ...
            // break; // proceed to next case [STATE_LASER_ON_WAITING]
            ...
            if (interpointBlanking) {
                ...
                // Advance the readingHead on the round-robin buffer:
                ...
                if (0) {//readingHead==0) { // TODO: this is not the right condition for a generic "end of figure"...
                    stateDisplayEngine = STATE_BLANKING_WAIT;
                } else {
