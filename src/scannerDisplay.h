...
#define DEFAULT_RENDERING_INTERVAL 10 // in microseconds
...
//#define BLOCKING_DELAYS // uncomment to have non-blocking delays (ISR period should be as small as possible))
